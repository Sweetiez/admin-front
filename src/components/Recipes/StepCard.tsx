...
const StepCard: React.FC<StepCardProps> = ({ recipe, step }) => {
  ...
  return (
    <div className="relative flex flex-col md:flex-row md:space-x-5 space-y-3 md:space-y-0 rounded-xl shadow-lg p-3 max-w-xs md:max-w-3xl mx-auto border border-white bg-white dark:bg-gray-600">
      ...
      <div className="w-full md:w-2/3 bg-white dark:bg-gray-600 flex flex-col space-y-2 p-3">
        <div className="mb-4 w-full bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
          <div className="py-2 px-4 bg-white dark:bg-gray-600 rounded-b-lg dark:bg-gray-800">
            <textarea
              id="description"
              onChange={(e) => {
