                  ...
                  <li>
                    <Link to="/admin/reports">
                      <div className="text-base text-gray-900 dark:text-white font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center dark:hover:bg-indigo-500 p-2">
                        ...
                        {reports?.length !== 0 ? (
                            <span className="right-0 inline-flex items-center justify-center px-1.5 py-1 text-xs font-bold leading-none text-white transform translate-x-1/2 -translate-y-1/2 bg-gold-100 rounded-full">
                            {reports?.length}
                          </span>
                        ) : (
                            <></>
