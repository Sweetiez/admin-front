...
import TrayModelRow from '../models/TrayModelRow';
...
const TrayList: React.FC = () => {
    ...
    return (
        <Page>
            ...
            <Modal modalContent={<CreateTray setOpenedModal={setAddModalState}/>} modalState={addModalState} setModalState={manageCloseCreateProductModal}/>
        </Page>
    );
};
